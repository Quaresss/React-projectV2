      ...
      <div className="container">
        <div className={style.footer__service}>
          ...
          <div className={style.footer__mailbox}>
            <p className={style.footer__title}>Подписывайтесь на нас</p>
            ...
            <form className={style.footer__form} onSubmit={handleEmailSubmit}>
              <p className={style.footer__label}>Получайте эксклюзивные предложения на свой почтовый ящик</p>
              <input
        ...
        <footer className={style.footer__copyright}>
          <div className={style.footer__reserved}>Все права защищены</div>
          <div className={style.footer__copy}>&copy;</div>
          <div className={style.footer__date}>Grill & Chill, {2024}</div>
        </footer>
      </div>
    </footer>
  );
