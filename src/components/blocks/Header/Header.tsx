      ...
      <div className="container">
        <div className={style.header}>
          ...
          <div className={cn(style.search, style.header__search)}>
            ...
            {isAuth ? (
              <LoginButton classNames={style.search__login} handleClick={handleLogOut} title={'Выйти'} />
            ) : (
              <LoginButton classNames={style.search__login} handleClick={handleLogin} title={'Войти'} />
            )}
