...
const TYPE_FOOD: TypeFoodItem[] = [
  ...
  { imageSrc: '/images/search-food/11.jpg', name: 'Суп' },
  { imageSrc: '/images/search-food/10.jpg', name: 'Картошка' },
  { imageSrc: '/images/search-food/9.jpg', name: 'Напитки' },
  { imageSrc: '/images/search-food/7.jpg', name: 'Рыба' },
  { imageSrc: '/images/search-food/6.png', name: 'Мясо' },
];
    ...
    <section className={style.searchFoodBlock} id="searchByFood">
      <div className="container">
        <div className={style.searchFood}>
          <h5 className={style.searchFood__title}>Поиск по товару</h5>
